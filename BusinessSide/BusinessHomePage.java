...
public class BusinessHomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button viewOrdersDelivered = findViewById(R.id.viewOrdersDelivered);
        ...
        viewOrdersDelivered.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open Orders Activity
                Intent intent = new Intent(BusinessHomePage.this, ViewOrdersDelivered.class);
                startActivity(intent);
            }
        });
    }
